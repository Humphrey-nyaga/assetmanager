...
public class SessionFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        if (httpSession.isNew() || StringUtils.isBlank((String) httpSession.getAttribute("loggedInId"))) {
            ...
            if (servletPath.equals("/login") || servletPath.equals("/signup") || servletPath.startsWith("/api/") || servletPath.equals("/index.jsp") ||servletPath.startsWith("/SoapWebServiceApi")|| servletPath.equals("/signup.jsp")) {
